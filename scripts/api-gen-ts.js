...
const PROGRAM_ID = "56YRTVX6MNrpQgnGQbzAq7xPyeqyY9ShDrpRNkyMpUgj";

const path = require("path");
const programDir = path.join(__dirname, "..", "programs", "vault");
const generatedIdlDir = path.join(__dirname, "..", "target", "idl");
const generatedSDKDir = path.join(__dirname, "..", "sdk-gen");
const { spawn } = require("child_process");
const { Solita } = require("@metaplex-foundation/solita");
const { writeFile } = require("fs/promises");

console.log(">", programDir, generatedIdlDir, generatedSDKDir);
